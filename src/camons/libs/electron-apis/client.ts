...
import { formatRouteMethodName } from "./utils"
...
interface IClient {
    ...
    get<TResponse = unknown>(route: string, config?: TConfig): Promise<TResponse>
    delete<TResponse = unknown>(route: string, config?: TConfig): Promise<TResponse>
