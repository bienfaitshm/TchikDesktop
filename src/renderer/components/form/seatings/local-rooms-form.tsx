      ...
      >
        ...
        <section className="space-y-6">
          <div className="flex flex-col gap-1">
            ...
            <p className="text-sm text-muted-foreground">
              Définissez comment la salle sera reconnue dans l'établissement.
            </p>
          </div>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  Saisissez le nom usuel utilisé dans l'établissement (ex:{" "}
                  <strong>Local 1</strong>).
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
        ...
        <section className="space-y-6">
          <div className="flex flex-col gap-1">
            ...
            <p className="text-sm text-muted-foreground">
              Paramétrez la capacité d'accueil et la disposition des places.
            </p>
          </div>
          ...
          <div className="flex items-start gap-2 p-3">
            ...
            <p className="text-[12px] text-blue-700 leading-relaxed">
              <strong>Note :</strong> La multiplication des rangs et colonnes
              définit la grille visuelle pour le placement lors des examens.
            </p>
          </div>
        </section>
