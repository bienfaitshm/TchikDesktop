              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription className="text-[12px]">
                    Ce nom figurera sur les listes de présence et les plans de
                    table (ex: <strong>Examen 1er Semestre</strong>).
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-medium">
                Affectation à l'Année Scolaire
              </p>
              <p className="text-xs text-muted-foreground leading-relaxed">
                La session sera automatiquement liée à l'année en cours.
                Assurez-vous que les effectifs par classe sont à jour avant de
