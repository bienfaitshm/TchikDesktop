// src/services/enrolement.service.ts
...
import { createUser } from "./account"; // Dépendance à un autre service
import { Sequelize, type Includeable, Op, WhereOptions } from "sequelize";
