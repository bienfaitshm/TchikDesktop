...
CREATE TABLE `__new_classroom_enrollments` (
	...
	`created_at` integer DEFAULT '"2026-07-08T13:16:25.765Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-07-08T13:16:25.765Z"' NOT NULL,
...
CREATE TABLE `__new_study_years` (
	...
	`start_date` integer DEFAULT '"2026-07-08T13:16:25.766Z"' NOT NULL,
	`end_date` integer DEFAULT '"2026-07-08T13:16:25.766Z"' NOT NULL,
	`school_id` text NOT NULL,
	`created_at` integer DEFAULT '"2026-07-08T13:16:25.765Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-07-08T13:16:25.765Z"' NOT NULL,
	FOREIGN KEY (`school_id`) REFERENCES `schools`(`school_id`) ON UPDATE no action ON DELETE cascade
...
CREATE TABLE `__new_users` (
	...
	`birth_date` integer DEFAULT '"2026-07-08T13:16:25.766Z"' NOT NULL,
	`birth_place` text,
	`school_id` text NOT NULL,
	`created_at` integer DEFAULT '"2026-07-08T13:16:25.765Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-07-08T13:16:25.765Z"' NOT NULL,
