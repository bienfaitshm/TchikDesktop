...
interface EnrollmentDocumentExport {
 ...
 * @example
 * ```ts
 * const fields = await createEnrollmentDocumentExportForm({
 *   schoolId: '123',
 *   yearId: '2024',
 ...
 * ```
 */
export const createEnrollmentDocumentExportForm = async (
  config: Readonly<EnrollmentDocumentExport>,
...
const validateConfig = (
  config: Readonly<EnrollmentDocumentExport>,
): Required<EnrollmentDocumentExport> => {
