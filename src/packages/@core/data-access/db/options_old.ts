...
import {
  CURRENCY_ENUM,
  CURRENCY_ENUM_TRANSLATIONS,
  ENROLLMENT_ACTION_ENUM,
  ENROLLMENT_ACTION_ENUM_TRANSLATIONS,
  FEE_SCHEDULES_ENUM,
  FEE_SCHEDULES_ENUM_TRANSLATIONS,
  MUTATION_ACTION_ENUM,
  MUTATION_ACTION_ENUM_TRANSLATIONS,
  PAYMENT_METHOD_ENUM,
  PAYMENT_METHOD_ENUM_TRANSLATIONS,
  SECTION_ENUM,
...
export const ENROLLMENT_ACTION_OPTIONS = getEnumOptions(
  ENROLLMENT_ACTION_ENUM,
  ENROLLMENT_ACTION_ENUM_TRANSLATIONS,
);

export const getEnrolLmentActionLabel = (value: ENROLLMENT_ACTION_ENUM) =>
  getEnumLabel(value, ENROLLMENT_ACTION_ENUM_TRANSLATIONS);
...
// --- FEE_SCHEDULES ---
export const FEE_SCHEDULES_OPTIONS = getEnumOptions(
  FEE_SCHEDULES_ENUM,
  FEE_SCHEDULES_ENUM_TRANSLATIONS,
);

export const getFeeScheduleLabel = (value: FEE_SCHEDULES_ENUM) =>
  getEnumLabel(value, FEE_SCHEDULES_ENUM_TRANSLATIONS);

// --- CURRENCY ---
export const CURRENCY_OPTIONS = getEnumOptions(
  CURRENCY_ENUM,
  CURRENCY_ENUM_TRANSLATIONS,
);

export const getCurrencyLabel = (value: CURRENCY_ENUM) =>
  getEnumLabel(value, CURRENCY_ENUM_TRANSLATIONS);

// --- PAYMENT METHOD ---
export const PAYMENT_METHOD_OPTIONS = getEnumOptions(
  PAYMENT_METHOD_ENUM,
  PAYMENT_METHOD_ENUM_TRANSLATIONS,
);

export const getPaymentMethodLabel = (value: PAYMENT_METHOD_ENUM) =>
  getEnumLabel(value, PAYMENT_METHOD_ENUM_TRANSLATIONS);
