  ...
  return (
    <Form {...form}>
      ...
      >
        ...
        <fieldset
          aria-labelledby="period-legend"
          className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 rounded-lg border text-muted-foreground"
        >
          <legend
            className="text-sm font-semibold uppercase tracking-wider text-muted-foreground mb-4 px-2 flex items-center gap-2"
            id="period-legend"
          >
        ...
        {form.formState.errors.root && (
          <div
            role="alert"
            className="flex items-center gap-2 p-3 text-sm font-medium text-red-700 bg-red-50 border border-red-200 rounded-md"
          >
