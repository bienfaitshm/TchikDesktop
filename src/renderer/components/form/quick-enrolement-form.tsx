...
export type QuickEnrollmentFormData = EnrollmentQuickCreate;
...
const StudentFields = () => {
  ...
  } = useFormContext<QuickEnrollmentFormData>();
...
> = ({
  formId,
  onSubmit,
  initialValues = DEFAULT_QUICK_ENROLLMENT_VALUES,
  classrooms = [],
}) => {
  const form = useZodForm({
    schema: EnrollmentQuickCreateSchema,
    initialValues: (initialValues ||
      DEFAULT_QUICK_ENROLLMENT_VALUES) as QuickEnrollmentFormData,
