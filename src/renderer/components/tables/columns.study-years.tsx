...
import type { StudyYear } from "@/packages/@core/data-access/db/schemas";
...
export const studyYearColumns: ColumnDef<StudyYear>[] = [
  {
  ...
  },
  {
    accessorKey: "status",
    header: "Statut",
    cell: ({ row }) => <StudyYearStatusBadge yearId={row.original.yearId} />,
  },
];
